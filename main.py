...
def get_articles_from_rss(rss_url):
    ...
    try:
        ...
        for entry in feed.entries:
            ...
            if pubdate.timestamp() <= last_hour_utc.timestamp():
...
def analyze_and_summarize(entries):
    ...
    for entry in entries:
        ...
        # print("\n\n-----------\nnews_content was: ", news_content, "\n===========\n")
        # with open('news_content.txt', 'a') as file:
        #     file.write(f"Link: {actual_link}\n")
        #     file.write(f"Content: {news_content}\n")
        #     file.write("\n===========\n")
        ...
        for split in splits:
            summary = "The following is generated by AI: \nLink: " + short_url + "\nAct: " + split
            if len(summary) < 275:
