...
config_list = config_list_from_json(
    ...
    filter_dict={"model": ["llama-3.2-3b-instruct-uncensored"]},  # comment out to get all
)
...
def get_articles_from_rss(rss_url):
    ...
    try:
        ...
        last_run = now_utc - timedelta(hours=5)
...
def analyze_and_summarize(entries, dry=True):
    ...
    for entry in entries:
        ...
        news_content = strip_scripts(news_content)
        ...
        ** Summary N**
        ...
        '''
        [INTRODUCTORY SUMMARY OF 2 or 3 SENTENCES]
        **Summary 1**
        Act: [ACTION/POLICY]
        Impact: [RATING]/10
        Analysis: [YOUR TERSE/CONCISE ANALYSIS]
